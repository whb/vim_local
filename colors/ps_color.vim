...
if s:style=='warm' 
  ...
  highlight Cursor		guifg=#f0f0f0	guibg=#555555
...
elseif s:style=='cool' 
  ...
  highlight Folded		guifg=NONE	guibg=#333333
  highlight FoldColumn		guifg=#e0e0e0	guibg=#555555
  ...
  highlight SignColumn		guifg=#e0e0e0	guibg=#555555
  ...
  if v:version >= 700
    ...
    highlight PmenuThumb	guifg=fg	guibg=#555555
    highlight TabLine		guifg=fg	guibg=#444444	gui=underline
    highlight TabLineFill	guifg=fg	guibg=#444444	gui=underline
    highlight TabLineSel	guifg=fg	guibg=NONE
